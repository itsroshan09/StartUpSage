...
<div class="sidebar-panel">
    ...
    <div class="user-panel">
        ...
        <!-- Form for Add User -->
        <form action="addcourseindex.php" method="POST">
            <button type="submit" class="user-button">Add Course</button>
        </form>

        <form action="addcoursedetails.php" method="POST">
            <button type="submit" class="user-button">Add Course Details</button>
        </form>
    
        <!-- Form for All Users -->
        <form action="deletecourseindex.php" method="POST">
